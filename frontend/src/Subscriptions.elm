...
subscriptions model =
    Sub.batch <|
        List.filterMap identity <|
            -- time updated every 5 seconds so torrent table cache is useful
            [ Just <| Time.every 5000 Tick
            ...
            , Just <| (Model.TorrentTable.dndSystem ColumnReordered).subscriptions model.dnd
            ]
